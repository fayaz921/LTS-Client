    ...
    return (
        <>
            <style>{`
                ...
                .dep-input::placeholder { color: #B0BBCA; }
                .cancel-btn:hover {
                ...
                .close-btn:hover { background: #F0EBE0 !important; color: #1B2A4A !important; }
                .toggle-track {
                ...
                >
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'flex-end', gap: '16px', paddingBottom: '24px' }}>
                            ...
                            <div>
                                <p style={{ margin: '0 0 3px', fontSize: '11px', fontWeight: 700, letterSpacing: '0.1em', color: '#D4A843', textTransform: 'uppercase' }}>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div style={{ marginBottom: '18px' }}>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Legal Affairs, Civil Court..."
                                    required
                                    className="dep-input"
                                />
                            </div>
                            ...
                            <div style={{ marginBottom: '20px' }}>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    placeholder="Address ya contact number..."
                                    className="dep-input"
                                />
                            </div>
                            ...
                            >
                                <div>
                                    ...
                                    <p style={{ margin: '2px 0 0', fontSize: '12px', color: form.isActive ? '#16A34A' : '#DC2626' }}>
                                        {form.isActive ? '✓ Active — visible in system' : '✗ Inactive — hidden from system'}
                                    </p>
                                </div>
                                <div
